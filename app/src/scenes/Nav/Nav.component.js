...
const Nav = () => {
    return (
        <nav style={{padding:0,margin:0}} className="navbar navbar-inverse navbar-static-top">
              ...
              <div className="collapse navbar-collapse" id="bs-navbar-collapse">
                <ul style={{padding:0,margin:0}} className="nav navbar-nav navbar-right top-nav">
                  ...
                  <li className="choice dropdown">
                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Tools
                  ...
                  <li className="choice dropdown">
                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Social Media
                      <span className="caret"></span>
                    </a>
                    <ul className="dropdown-menu">
                      <li className="choice">
